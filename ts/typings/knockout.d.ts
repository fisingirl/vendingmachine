// Type definitions for Knockout v3.3.0
...
interface KnockoutSubscribable<T> extends KnockoutSubscribableFunctions<T> {
    ...
    getSubscriptionsCount(event?: any): number;
}
...
interface KnockoutUtils {
    ...
    simpleHtmlParse(html: string, documentContext?: Document): any[];

    jQueryHtmlParse(html: string, documentContext?: Document): any[];

    parseHtmlFragment(html: string, documentContext?: Document): any[];
...
interface KnockoutNativeTemplateEngine {
    ...
    renderTemplateSource(templateSource: Object, bindingContext?: KnockoutBindingContext, options?: Object, templateDocument?: Document): any[];
}
...
interface KnockoutComputedContext {
    ...
    isInitial: () => boolean;
    isSleeping: boolean;
    ignoreDependencies: (callback: any, callbackTarget?: any, callbackArgs?: Array<any>) => any;
}
